...
export default {
  ...
  buy_cmu_alert: 'How many BOS equivalent CMU do you want to purchase?',
  ...
  after_sell_cmu_alert: 'Pay attention to BOS balance changes later',
  ...
  app_FTextBubble:'Exchange CMU to BOS',
