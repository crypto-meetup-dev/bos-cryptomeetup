...
export default {
  ...
  buy_cmu_alert: 'Сколько BOS эквивалентных CMU вы хотите купить?',
  ...
  after_sell_cmu_alert: 'Обратите внимание на изменения баланса BOS позже',
  ...
  app_FTextBubble:'Обмен CMU на BOS',
