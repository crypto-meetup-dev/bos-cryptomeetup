...
export default {
  ...
  countryName: '{countryName}贊助者',
  newCountryName: '成為新的 {countryName}贊助者, 您需要支付 {price}',
  countryNameScatter: '使用Scatter桌面版進行支付',
  scatterDesktop: 'Scatter案頭版使支付更加便利、安全',
  noScatter: '無法檢測到Scatter桌面版',
  wnlockScatter: '如果你想使用Scatter桌面版支付，請將其打開並解鎖之後，刷新此頁面。',
  useScatter: '如您尚無，請參閱：[How to use Scatter](https://support.newdex.io/hc/en-us/articles/360016322611-How-to-Use-Scatter-Desktop)',
  loginScatter: '使用Scatter登錄後繼續',
  scatterPay: '使用Scatter支付',
  scatterAppPay: '使用錢包APP支付',
  supportPay: '我們支持[Math Wallet](http://www.mathwallet.org/en/),[Token Pocket](https://www.mytokenpocket.vip/en/)and[MEET.ONE](http:// meet.one/)掃碼支付:',
  appPay: '在APP中進行支付',
  loginPay: '登錄繼續',
  appPayOk: '我已使用錢包APP完成支付',
  payClose: '關閉',
  loginSuccess: '登錄成功',
  copy: '複製',
  sponsor: '贊助者',
  yuoBuy: '該國家由您向 @{owner}購買',
  priceNum: '支付{price}作為新的讚助商',
